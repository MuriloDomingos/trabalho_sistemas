...
export default function Checkout() {
  ...
  function validarPedido() {
    ...
    Alert.alert('Pedido confirmado!', 'Seu pedido foi finalizado com sucesso.', [
      { text: 'OK', onPress: () => router.replace({ pathname: '/confirmacao', params: { nome, endereco, numero, pagamento, total: total.toFixed(2), itens: JSON.stringify(itens.map((i) => ({ nome: i.nome, quantidade: i.quantidade }))) } }) },
    ]);
  }
